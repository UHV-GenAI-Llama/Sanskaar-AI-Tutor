        ...
        child: Center(
          child: Container(
            ...
            decoration: BoxDecoration(
              border: Border.all(
                  color: Colors.black, width: 1), // Fixed border size
              ...
              children: [
                Container(
                  constraints: const BoxConstraints(
                    maxHeight:
                        80.0, // Adjust this value to control the max height (3-4 lines)
                  ),
                  child: SingleChildScrollView(
                  ...
                  return GestureDetector(
                    onTap: () {
                      if (!widget.showExplanation) {
                        ...
                        widget.onSelected(
                            option == widget.question.correctOption);
                      }
                    },
                    child: Container(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: SingleChildScrollView(
                            ...
                            child: Text(
                              widget.question
                                  .explanation, // Display the explanation text
                              style: const TextStyle(
                                fontSize: 14,
                                color: Colors.black,
                              ),
