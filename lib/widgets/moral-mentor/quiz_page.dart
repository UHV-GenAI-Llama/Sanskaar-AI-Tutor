    ...
    setState(() {
      ...
      if (_currentQuestionIndex < questions.length - 1) {
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) =>
                QuizResult(score: _score, totalQuestions: questions.length),
          ),
        );
      }
    });
            ...
            Card(
              ...
              shape: RoundedRectangleBorder(
                side: const BorderSide(
                    color: Colors.white, width: 2.0), // Added cyan border
                borderRadius: BorderRadius.circular(8.0),
              ),
              child: Padding(
                padding: const EdgeInsets.all(
                    16.0), // Padding inside each question card
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(
                      ...
                      style: const TextStyle(
                        fontSize:
                            20.0, // Increased font size for question titles
                        fontWeight: FontWeight.bold,
                      ),
                    ),
                    const SizedBox(
                        height:
                            10.0), // Space between question title and content
                    QuizQuestion(
                      question: question,
                    ...
                    if (_showExplanation) ...[
                      ...
                      ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor:
                              Colors.purple.shade100, // Light purple color
