...
class _NutritionState extends State<Nutrition> {
  ...
  void _sendMessage() async {
    ...
    try {
      ...
      String responseMessage = quizData['response'] ??
          'No message from server'; // Adjusted to match the API response
      ...
      child: Align(
        ...
        child: Row(
          ...
          children: [
            if (showImage && !isUser)
              CircleAvatar(
                backgroundImage: AssetImage('assets/images/nutrition.jpeg'),
                radius: 20,
              ),
